    ...
    <el-container class="app-container">
      ...
      >
        <div>
          ...
          <el-link :underline="false" href="https://github.com/Lruihao/vue-el-demo" target="_blank">
            <img
              src="https://img.shields.io/github/stars/Lruihao/vue-el-demo?style=social"
              alt="GitHub stars"
        ...
        >
          <template #default="{ row }">
            <el-tooltip effect="dark" content="查看源码" placement="top">
              <el-link
                icon="el-icon-view"
                :href="`https://github.com/Lruihao/vue-el-demo/blob/main/src/views${row.path === '/' ? '/home' : row.path}.vue`"
                type="primary"
                target="_blank"
                :underline="false"
